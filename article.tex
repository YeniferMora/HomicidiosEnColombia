...
Adicionalmente, la aplicación de algoritmos de reglas de asociación como \texttt{Apriori} y \texttt{FP-Growth} permitió ir más allá del análisis descriptivo, descubriendo perfiles de riesgo diferenciados. Se identificaron patrones específicos, incluyendo aquellos relacionados con la violencia de género, donde el uso de armas de fuego se asocia fuertemente con el contexto de vía pública y el perfil demográfico de la víctima.

Complementariamente, el análisis de agrupación reveló estructuras latentes en los datos. A nivel nacional, el algoritmo DBSCAN identificó dos grandes patrones de violencia y una clase de casos atípicos. A nivel local (Bogotá), se descubrieron perfiles específicos, incluyendo un cluster fuertemente asociado a terrorismo y otro caracterizado por violencia urbana común. El enfoque multinivel y la combinación de técnicas (PCA, MCA, DBSCAN, GMM, K-Means, K-Modes) demostraron ser eficaces para revelar tanto tendencias generales como dinámicas regionales específicas.

En conjunto, estos análisis ofrecen una base sólida para futuras investigaciones y para el diseño de políticas públicas de prevención más focalizadas, basadas en evidencia y adaptadas a los distintos contextos territoriales.

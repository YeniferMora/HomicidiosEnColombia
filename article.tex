...
\toprule
\textbf{Modelo}  & \textbf{CV F1-Score} & \textbf{Test Accuracy} & \textbf{Test F1-Score} \\
\midrule
...
Los modelos tradicionales restantes mostraron rendimientos variados: Naive Bayes alcanzó un F1-Score de prueba de 0.668 y Random Forest obtuvo 0.650.
